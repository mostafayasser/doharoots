...
import 'package:doharoots/pages/categories.dart';
import 'package:doharoots/pages/explore.dart';
import 'package:doharoots/pages/profile.dart';
import 'package:doharoots/pages/videos.dart';
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(
              icon: Icon(iconList[1]), label: 'videos'.tr()),
          BottomNavigationBarItem(
              icon: Icon(
                iconList[2],
                size: 25,
              ...
              label: 'categories'.tr()),
          BottomNavigationBarItem(
              icon: Icon(iconList[3]), label: 'profile'.tr())
        ],
      ),
      body: PageView(
